...
pub fn format_dry_run(groups: &HashMap<PathBuf, Vec<PathBuf>>, output_dir: &str) -> String {
    ...
    for dir in dirs {
        ...
        let output_file = PathBuf::from(output_dir).join(format!("{}.mp3", dir_name));
...
mod tests {
    ...
    fn test_format_dry_run() {
        ...
        let output = format_dry_run(&groups, "out_dir");
